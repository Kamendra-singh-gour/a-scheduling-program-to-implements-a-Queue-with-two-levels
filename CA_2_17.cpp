...
void my_check(vector<P_d> mv)
{
	...
	{
		cout<<" Pid :"<<mv[i].Pid<<" Arrival_time : "<<mv[i].A_time<<" B_time : "<<mv[i].B_time<<" Priority : "<<mv[i].Priority<<endl;
	}
...
int main()
{
	...
	cin>>n;
	cout<<"Enter Input(Ineteger) as shown with order: ""Pid""|""Arrival_time""|""Burst_Time""|""Priority"<<endl;
	for( i= 0; i< n; i++ )
	{
	...
	cout<<"output is:""Pid""|""Response_time""|""Finish_Time""|""Waiting_time"<<endl;
